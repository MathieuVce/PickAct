...
export default function InviteShare({ code }: { code: string }) {
  ...
  // window n'est disponible qu'au clic (côté client), pas au rendu serveur.
  function copyLink() {
    copy(`${window.location.origin}/join/${code}`, "link");
  }
  ...
  return (
    <div className="card">
      ...
      <div className="mt-4 flex flex-col gap-3 sm:flex-row">
        <div className="border-border bg-surface-2 flex flex-1 items-center justify-between gap-2 rounded-xl border px-3 py-2">
